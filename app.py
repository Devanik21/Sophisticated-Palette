...
st.set_page_config(
    page_title="Sophisticated Palette",
    page_icon="🎨",
    layout="wide"
)
...
<style>
    ...
    .vintage-header {
        ...
        border-bottom: 3px double #96754a;
        border-top: 3px double #96754a;
        margin-bottom: 2rem;
        position: relative;
    }
    ...
    .sidebar-title {
        ...
        padding-bottom: 1rem;
        border-bottom: 2px solid #96754a;
    ...
    hr {
        border: none;
        height: 2px;
        background: linear-gradient(to right, transparent, #96754a, transparent);
        margin: 2rem 0;
    }
